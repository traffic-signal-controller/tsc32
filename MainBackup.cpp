		...
		if (resultBytes[0] == 0xaa && resultBytes[1] == 0x55)
		{
			...
			{	
				...
				case MAINBACKUP_RECEVIE_READ_MANUAL:
					...
					ACE_DEBUG((LM_DEBUG,"%s:%d ManualButtonSts: %d\n",__FILE__,__LINE__,ManualButtonSts));					pMainBackup->OperateManual(ManualButtonSts);
					//delete ManualBytes
					break;
