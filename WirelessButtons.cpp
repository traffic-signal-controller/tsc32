...
Description:    ÍË³öÎÞÏßÒ£¿Ø°´¼ü£¬»Ö¸´×ÔÖ÷¿ØÖÆ.¶¨Ê±ÍË³ö
Input:           ÎÞ          
Output:         ÎÞ
Return:         ÎÞ
Date:           20141023
...
void CWirelessBtn::BackToAuto()
{
	...
	else if(m_ucLastManualSts==BUTTON_MANUAL_NEXT_STEP) //µ±´ÓÊÖ¶¯ÏÂÒ»²½ÍË³ö Ôò»ÆµÆ¹ý¶É3Ãë
	{
...
/****************************************************************
Function:       CWirelessBtn::EntryWirelessManul
Description:    ÍË³öÎÞÏßÒ£¿Ø°´¼ü£¬»Ö¸´×ÔÖ÷¿ØÖÆ¡£ÊÖ¶¯°´
Input:           ÎÞ          
Output:         ÎÞ
Return:         ÎÞ
Date:           20141023
...
void CWirelessBtn::RecvMacCan(SCanFrame sRecvCanTmp)
{
	...
	if(RecvType == 0x2 && bTransitSetp == false) //ÊÖ¿Ø·Ç¹ý¶É²½
	{		
		...
		if(iAuto_Manul == 0x0) //×Ô¶¯×´Ì¬
		{
			...
			else
			{
				...
				CWirelessBtnTimer::CreateInstance()->Resettimeout();  //ÍË³ö¶¨Ê±Æ÷³¬Ê±¼ÆÊýÖÃÎª0
			}
		}
